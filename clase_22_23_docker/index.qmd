...
## Lab: LocalStack Infrastructure {.smaller}

En el siguiente laboratorio práctico vamos a:

1. **Configurar LocalStack** con Docker Compose
2. **Desplegar servicios AWS** localmente:
   ...
   - Secrets Manager
   - Cognito
3. **Usar CloudFormation** para infraestructura como código

::: {.callout-tip}
Accede al lab en: `lab-localstack/index.html`
:::
